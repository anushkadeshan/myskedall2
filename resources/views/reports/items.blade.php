    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-3 mb-4">
                        <font class="text-dark" style="font-size:24px">{{__('msg.Total Items')}}  :  <strong>{{$total_items}}</strong></font> 
                    </div>
                    <div class="col-md-3 mb-4">
                        <font class="text-danger" style="font-size:24px">{{__('msg.Items Allocated')}}  :  <strong>{{$total_allocated}}</strong></font> 
                    </div>
                    <div class="col-md-3 mb-4">
                        <font class="text-success" style="font-size:24px">{{__('msg.Items Available')}}  :  <strong>{{$total_items-$total_allocated}}</strong></font> 
                    </div>
                </div>
            </div>
        </div>
