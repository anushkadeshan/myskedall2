...
<li class="breadcrumb-item active"> {{__('msg.Reports - Items')}}</li>
@endsection
@section('content')
...
<div class="content">
    ...
    <div class="card">
        <section class="card-header">
            <h1 class="pull-left">{{__('msg.Reports - Items')}}</h1>
            <h1 class="pull-right">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    <font class="text-dark" style="font-size:20px">{{__('msg.Total Items')}}  :  <strong>{{$total_items}}</strong></font>
                </div>
                <div class="col-md-4 mb-4">
                    <font class="text-danger" style="font-size:20px">{{__('msg.Items Allocated')}}  :  <strong>{{$total_allocated}}</strong></font>
                </div>
                <div class="col-md-4 mb-4">
                    <font class="text-success" style="font-size:20px">{{__('msg.Items Available')}}  :  <strong>{{$total_items-$total_allocated}}</strong></font>
                </div>
            </div>
        </div>
    </div>
