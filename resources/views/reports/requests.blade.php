    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-3 mb-4">
                        <font class="text-dark" style="font-size:24px">{{__('msg.Total Locations')}}  :  <strong>{{$total_allocated+$total_available+$total_rejected}}</strong></font> 
                    </div>
                    <div class="col-md-3 mb-4">
                        <font class="text-danger" style="font-size:24px">{{__('msg.Locations Allocated')}}  :  <strong>{{$total_allocated}}</strong></font> 
                    </div>
                    <div class="col-md-3 mb-4">
                        <font class="text-success" style="font-size:24px">{{__('msg.Locations Available')}}  :  <strong>{{$total_available}}</strong></font> 
                    </div>
                    <div class="col-md-3 mb-4">
                        <font class="text-warning" style="font-size:24px">{{__('msg.Locations Rejected')}}  :  <strong>{{$total_rejected}}</strong></font> 
                    </div>
                </div>
            </div>
        </div>
