...
<li class="breadcrumb-item active"> {{__('msg.Reports - Functions')}}</li>
@endsection
@section('content')
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    <font class="text-dark" style="font-size:20px">{{__('msg.Total Functions')}}  :  <strong>{{$total_items}}</strong></font>
                </div>
                <div class="col-md-4 mb-4">
                    <font class="text-danger" style="font-size:20px">{{__('msg.Functions Allocated')}}  :  <strong>{{$total_allocated}}</strong></font>
                </div>
                <div class="col-md-4 mb-4">
                    <font class="text-success" style="font-size:20px">{{__('msg.Functions Available')}}  :  <strong>{{$total_items-$total_allocated}}</strong></font>
                </div>
            </div>
        </div>
    </div>
