...
<li class="breadcrumb-item active"> {{__('msg.Reports - Values')}}</li>
@endsection
@section('content')
    ...
    <div class="content">
        ...
        <div class="card">
            <section class="card-header">
                <h1 class="pull-left">{{__('msg.Reports - Values')}}</h1>
                <h1 class="pull-right">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-3 mb-4">
                        <font class="text-dark" style="font-size:18px">{{__('msg.Total Locations')}}  :  <strong>{{number_format($total_allocated+$total_available+$total_rejected)}}</strong></font>
                    </div>
                    <div class="col-md-3 mb-4">
                        <font class="text-danger" style="font-size:18px">{{__('msg.Value Allocated')}}  :  <strong>{{number_format($total_allocated)}}</strong></font>
                    </div>
                    <div class="col-md-3 mb-4">
                        <font class="text-success" style="font-size:18px">{{__('msg.Value Available')}}  :  <strong>{{number_format($total_available)}}</strong></font>
                    </div>
                    <div class="col-md-3 mb-4">
                        <font class="text-warning" style="font-size:18px">{{__('msg.Value Rejected')}}  :  <strong>{{number_format($total_rejected)}}</strong></font>
                    </div>
                </div>
            </div>
        </div>
