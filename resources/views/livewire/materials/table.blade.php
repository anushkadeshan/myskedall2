            ...
            @foreach($materials as $material)
                <tr>
                    ...
                    <td>
                        ...
                        <div class='btn-group'>
                            <a wire:click.prevent="view({{$material->id}})"class='btn btn-warning btn-xs'><i class="fa fa-eye"></i></a>
                            <a wire:click.prevent="edit({{$material->id}})" class='btn btn-success btn-xs'><i class="fa fa-edit"></i></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h5>@lang('msg.Allocated Locations')</h5> 
                        @php
