<div class="row">
    <div class="col-md-6">
        ...
        <!-- Description Field -->
        <div class="form-group col-sm-12 col-lg-12 mb-4">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group col-sm-12 mb-4">
          ...
          <!-- Contact Us Field -->
        <div class="form-group col-sm-12 mb-4">
            <label for=""> {{__('msg.Group Banner')}} </label>
            <input type="file" name="group_banner" class="form-control" id="">
        </div>

        <div class="form-group col-sm-12 mb-4">
            <label for="">{{__('msg.Group Logo')}}</label>
            <input type="file" name="group_logo" class="form-control" id="">
        </div>
