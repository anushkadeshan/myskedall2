...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group col-sm-12">
            ...
            {!! Form::select('status', array('' => 'Select','1' => 'Approve', '0' => 'Reject'),null,['class' => 'form-control','maxlength' => 255,'maxlength' => 255]) !!}
        </div>
        <!-- Have Warning Field -->
        <div class="form-group col-sm-12">
        ...
        <!-- Submit Field -->
        <div class="form-group col-sm-12">
            {!! Form::submit( trans('msg.update'), ['class' => 'btn btn-primary']) !!}
