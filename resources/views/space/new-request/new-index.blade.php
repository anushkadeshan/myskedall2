...
<li class="breadcrumb-item active">{{__('msg.New Requests')}}</li>
@endsection
        ...
        <div class="card-body">
            <div class="row">
                <form action="" method="post" id="request_form">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <input type="button" class="btn btn-success mr-3" onclick="RequestSpace()" value="{{ __('msg.Request SPACE') }}">
                            <button type="submit" class="btn btn-primary mr-3" name="saveAsDraft" value="1">{{ __('msg.save as draft') }}</button>
                    ...
                    <div class="modal fade" id="ModelId12" role="dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="{{url('app/space/12')}}"><button type="button" class="btn btn-default" data-bs-dismiss="modal">{{ __('msg.no') }}</button></a>
                            </div>
                        </div>
                    ...
                    <div class="modal fade" id="successModel" role="dialog">
                        <div class="modal-dialog modal-sm" style="top:30%">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <a href="{{url('app/space/12')}}"><button type="button" class="btn btn-default" data-bs-dismiss="modal">{{ __('msg.close') }}</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog" role="document" style="width:95%; max-width:500px;">
                            <div class="modal-content">
                                <div class="modal-body" style="text-align:left">
                                    ...
                                    <button type="button" class="btn btn-success" onclick="ShareSpaceRequestEmail()"
                                        style="width:90px;">{{ __('msg.submit') }}</button>
                                    <a href="{{url('app/space/12')}}"><button type="button" class="btn btn-default" data-bs-dismiss="modal"
