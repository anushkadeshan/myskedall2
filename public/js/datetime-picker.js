...
gj.widget = function() {
    ...
    function(a) {
        ...
        base: {
            ...
            locale: "en-us",
            icons: {
                rightIcon: '<span data-feather="calendar"></span>',
                previousMonth: '<span data-feather="chevron-left"><h5><</h5></span>',
                nextMonth: '<span data-feather="chevron-right"><h5>></h5></span>'
            },
            fontSize: void 0,
            size: "default",
            modal: !1,
    ...
    function(a) {
        ...
        base: {
            ...
            size: "default",
            icons: {
                rightIcon: '<button type="button"><i class="glyphicon glyphicon-time" /></button>'
            },
            style: {
                modal: "gj-modal",
