    ...
    <div class="flex flex-col items-center relative">
        ...
        <div x-show="show" x-on:click.away="show = false" class="z-50 absolute mt-16 -mr-4 shadow-2xl top-100 bg-white w-96 right-0 rounded max-h-select overflow-y-auto" x-cloak>
            <div class="flex flex-col w-full">
                ...
                <div>
                    <div class="@unless($column['hidden']) hidden @endif cursor-pointer w-full border-gray-800 border-b bg-gray-900 text-gray-500 hover:bg-blue-600 hover:text-white" wire:click="toggle({{$index}})">
